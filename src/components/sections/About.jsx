    ...
    <SectionWrapper id="fixed-target" className="about">
      ...
      >
       ...
       <p className="meta-des">
        SuitVerse suits are <span className="nft-yell">suit-inspired NFTs</span> that live in <span className="art-one">artwork form</span> and <span className="art-two">augmented reality</span>. <br />
