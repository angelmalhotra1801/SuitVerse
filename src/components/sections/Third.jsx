    ...
    <SectionWrapper id="fixed-target" className="about">
      <LeftContainer data-scroll data-scroll-delay=".15" data-scroll-speed="1">
        ...
        <p className="meta-des">
          SuitVerse is building to last. Our genesis mint is just the begining.
        </p>
      </LeftContainer>
      <Container data-scroll data-scroll-delay=".15" data-scroll-speed="1">
        <div class="row">
          <div class="col col1">
            ...
            <p className="fut-des">
              In <span className="q-yell">Q3 of 2022</span>, the SuitVerse
              genesis <br />
              SuitVerse NFT collection of 10,000 hand- <br />
